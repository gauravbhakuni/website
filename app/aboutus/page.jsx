...
const AboutUs = () => {
  return (
    <div className="md:px-16 py-12 bg-blue-200">
      ...
      <div className="bg-green-800 border border-white rounded-md py-8 pl-4">
